...
func TestCreate(t *testing.T) {
	...
	newSubcategory := model.NewQuestionsSubcategory{
		Name:       gofakeit.Name(),
	...
	t.Run("Create placeholder implementation test", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("QuestionsSubcategoryService.Create() error = %v\n", err)
		}
	})
}
...
func TestUpdate(t *testing.T) {
	...
	id := int(gofakeit.Int64())
	updatedSubcategory := model.UpdatedQuestionsSubcategory{
		Name: &text,
	}
	...
	t.Run("Update placeholder implementation test", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("QuestionsSubcategoryService.Update() error = %v\n", err)
		}
	})
}
...
func TestDelete(t *testing.T) {
	...
	t.Run("Delete placeholder implementation test", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("QuestionsSubcategoryService.Delete() error = %v\n", err)
		}
	})
}
