...
type SetRepositoryMock struct {
	...
	funcListByIDs          func(ctx context.Context, ids []int64) (spa1 []*model.Set, err error)
	...
	ListByIDsMock          mSetRepositoryMockListByIDs
...
func NewSetRepositoryMock(t minimock.Tester) *SetRepositoryMock {
	...
	m.ListByIDsMock = mSetRepositoryMockListByIDs{mock: m}
	m.ListByIDsMock.callArgs = []*SetRepositoryMockListByIDsParams{}
...
type mSetRepositoryMockListByIDs struct {
	optional           bool
	mock               *SetRepositoryMock
	defaultExpectation *SetRepositoryMockListByIDsExpectation
	expectations       []*SetRepositoryMockListByIDsExpectation

	callArgs []*SetRepositoryMockListByIDsParams
	mutex    sync.RWMutex
...
// SetRepositoryMockListByIDsExpectation specifies expectation struct of the SetRepository.ListByIDs
type SetRepositoryMockListByIDsExpectation struct {
	mock               *SetRepositoryMock
	params             *SetRepositoryMockListByIDsParams
	paramPtrs          *SetRepositoryMockListByIDsParamPtrs
	expectationOrigins SetRepositoryMockListByIDsExpectationOrigins
	results            *SetRepositoryMockListByIDsResults
	returnOrigin       string
	Counter            uint64
}

// SetRepositoryMockListByIDsParams contains parameters of the SetRepository.ListByIDs
type SetRepositoryMockListByIDsParams struct {
	ctx context.Context
	ids []int64
}

// SetRepositoryMockListByIDsParamPtrs contains pointers to parameters of the SetRepository.ListByIDs
type SetRepositoryMockListByIDsParamPtrs struct {
	ctx *context.Context
	ids *[]int64
}

// SetRepositoryMockListByIDsResults contains results of the SetRepository.ListByIDs
type SetRepositoryMockListByIDsResults struct {
	spa1 []*model.Set
	err  error
}

// SetRepositoryMockListByIDsOrigins contains origins of expectations of the SetRepository.ListByIDs
type SetRepositoryMockListByIDsExpectationOrigins struct {
	origin    string
	originCtx string
	originIds string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmListByIDs *mSetRepositoryMockListByIDs) Optional() *mSetRepositoryMockListByIDs {
	mmListByIDs.optional = true
	return mmListByIDs
}

// Expect sets up expected params for SetRepository.ListByIDs
func (mmListByIDs *mSetRepositoryMockListByIDs) Expect(ctx context.Context, ids []int64) *mSetRepositoryMockListByIDs {
	if mmListByIDs.mock.funcListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Set")
	}

	if mmListByIDs.defaultExpectation == nil {
		mmListByIDs.defaultExpectation = &SetRepositoryMockListByIDsExpectation{}
	}

	if mmListByIDs.defaultExpectation.paramPtrs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by ExpectParams functions")
	}

	mmListByIDs.defaultExpectation.params = &SetRepositoryMockListByIDsParams{ctx, ids}
...
// ExpectCtxParam1 sets up expected param ctx for SetRepository.ListByIDs
func (mmListByIDs *mSetRepositoryMockListByIDs) ExpectCtxParam1(ctx context.Context) *mSetRepositoryMockListByIDs {
	if mmListByIDs.mock.funcListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Set")
	}
	...
	if mmListByIDs.defaultExpectation.params != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Expect")
	}

	if mmListByIDs.defaultExpectation.paramPtrs == nil {
		mmListByIDs.defaultExpectation.paramPtrs = &SetRepositoryMockListByIDsParamPtrs{}
	}
...
// ExpectIdsParam2 sets up expected param ids for SetRepository.ListByIDs
func (mmListByIDs *mSetRepositoryMockListByIDs) ExpectIdsParam2(ids []int64) *mSetRepositoryMockListByIDs {
	if mmListByIDs.mock.funcListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Set")
	}
...
// Inspect accepts an inspector function that has same arguments as the SetRepository.ListByIDs
func (mmListByIDs *mSetRepositoryMockListByIDs) Inspect(f func(ctx context.Context, ids []int64)) *mSetRepositoryMockListByIDs {
	if mmListByIDs.mock.inspectFuncListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("Inspect function is already set for SetRepositoryMock.ListByIDs")
	}
...
// Return sets up results that will be returned by SetRepository.ListByIDs
func (mmListByIDs *mSetRepositoryMockListByIDs) Return(spa1 []*model.Set, err error) *SetRepositoryMock {
	if mmListByIDs.mock.funcListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Set")
	}

	if mmListByIDs.defaultExpectation == nil {
		mmListByIDs.defaultExpectation = &SetRepositoryMockListByIDsExpectation{mock: mmListByIDs.mock}
	}
	mmListByIDs.defaultExpectation.results = &SetRepositoryMockListByIDsResults{spa1, err}
	mmListByIDs.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmListByIDs.mock
}

// Set uses given function f to mock the SetRepository.ListByIDs method
func (mmListByIDs *mSetRepositoryMockListByIDs) Set(f func(ctx context.Context, ids []int64) (spa1 []*model.Set, err error)) *SetRepositoryMock {
	if mmListByIDs.defaultExpectation != nil {
		mmListByIDs.mock.t.Fatalf("Default expectation is already set for the SetRepository.ListByIDs method")
	}

	if len(mmListByIDs.expectations) > 0 {
		mmListByIDs.mock.t.Fatalf("Some expectations are already set for the SetRepository.ListByIDs method")
	}
...
// When sets expectation for the SetRepository.ListByIDs which will trigger the result defined by the following
// Then helper
func (mmListByIDs *mSetRepositoryMockListByIDs) When(ctx context.Context, ids []int64) *SetRepositoryMockListByIDsExpectation {
	if mmListByIDs.mock.funcListByIDs != nil {
		mmListByIDs.mock.t.Fatalf("SetRepositoryMock.ListByIDs mock is already set by Set")
	}

	expectation := &SetRepositoryMockListByIDsExpectation{
		mock:               mmListByIDs.mock,
		params:             &SetRepositoryMockListByIDsParams{ctx, ids},
		expectationOrigins: SetRepositoryMockListByIDsExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmListByIDs.expectations = append(mmListByIDs.expectations, expectation)
	return expectation
}

// Then sets up SetRepository.ListByIDs return parameters for the expectation previously defined by the When method
func (e *SetRepositoryMockListByIDsExpectation) Then(spa1 []*model.Set, err error) *SetRepositoryMock {
	e.results = &SetRepositoryMockListByIDsResults{spa1, err}
	return e.mock
}

// Times sets number of times SetRepository.ListByIDs should be invoked
func (mmListByIDs *mSetRepositoryMockListByIDs) Times(n uint64) *mSetRepositoryMockListByIDs {
	if n == 0 {
		mmListByIDs.mock.t.Fatalf("Times of SetRepositoryMock.ListByIDs mock can not be zero")
	}
...
func (mmListByIDs *mSetRepositoryMockListByIDs) invocationsDone() bool {
...
// ListByIDs implements mm_repository.SetRepository
func (mmListByIDs *SetRepositoryMock) ListByIDs(ctx context.Context, ids []int64) (spa1 []*model.Set, err error) {
	...
	mm_params := SetRepositoryMockListByIDsParams{ctx, ids}
	...
	if mmListByIDs.ListByIDsMock.defaultExpectation != nil {
		...
		mm_got := SetRepositoryMockListByIDsParams{ctx, ids}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmListByIDs.t.Errorf("SetRepositoryMock.ListByIDs got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.ids != nil && !minimock.Equal(*mm_want_ptrs.ids, mm_got.ids) {
				mmListByIDs.t.Errorf("SetRepositoryMock.ListByIDs got unexpected parameter ids, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmListByIDs.t.Errorf("SetRepositoryMock.ListByIDs got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
		...
		if mm_results == nil {
			mmListByIDs.t.Fatal("No results are set for the SetRepositoryMock.ListByIDs")
		}
	...
	mmListByIDs.t.Fatalf("Unexpected call to SetRepositoryMock.ListByIDs. %v %v", ctx, ids)
	return
}

// ListByIDsAfterCounter returns a count of finished SetRepositoryMock.ListByIDs invocations
func (mmListByIDs *SetRepositoryMock) ListByIDsAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmListByIDs.afterListByIDsCounter)
}

// ListByIDsBeforeCounter returns a count of SetRepositoryMock.ListByIDs invocations
func (mmListByIDs *SetRepositoryMock) ListByIDsBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmListByIDs.beforeListByIDsCounter)
}

// Calls returns a list of arguments used in each call to SetRepositoryMock.ListByIDs.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmListByIDs *mSetRepositoryMockListByIDs) Calls() []*SetRepositoryMockListByIDsParams {
	mmListByIDs.mutex.RLock()

	argCopy := make([]*SetRepositoryMockListByIDsParams, len(mmListByIDs.callArgs))
...
// the number of defined expectations
func (m *SetRepositoryMock) MinimockListByIDsDone() bool {
...
func (m *SetRepositoryMock) MinimockListByIDsInspect() {
	for _, e := range m.ListByIDsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to SetRepositoryMock.ListByIDs at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.ListByIDsMock.invocationsDone() && afterListByIDsCounter > 0 {
		m.t.Errorf("Expected %d calls to SetRepositoryMock.ListByIDs at\n%s but found %d calls",
