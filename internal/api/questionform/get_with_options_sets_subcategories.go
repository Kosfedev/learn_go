...
func (i *Implementation) GetWithOptionsSetsSubcategories(ctx context.Context, req *desc.GetRequest) (*desc.GetResponse, error) {
	questionForm, err := i.questionFormService.GetWithOptionsSetsSubcategories(ctx, req.Id)
	if err != nil {
		return nil, err
	}
